...
Blockly.JavaScript.forBlock.turnRight = function(block) {
    ...
    return `thisTarget.setDirection(thisTarget.direction + ${degrees})\n`
}
...
Blockly.JavaScript.forBlock.turnLeft = function(block) {
    const degrees = Blockly.JavaScript.valueToCode(block, "degrees", 0) || 0
    return `thisTarget.setDirection(util.target.direction - ${degrees})\n`
}
Blockly.Blocks.goTo = {
...
Blockly.JavaScript.forBlock.goTo = function(block) {
    ...
    if (block.getInput('value')) {
        ...
        return `thisTarget.setXY(findPosition("${preset}", ${value}))\n`
    }
    return `thisTarget.setXY(findPosition("${preset}"))\n`
}
...
Blockly.JavaScript.forBlock.changeByXY = function(block) {
    const x = Blockly.JavaScript.valueToCode(block, "x", 0) || 0
    const y = Blockly.JavaScript.valueToCode(block, "y", 0) || 0
    return `thisTarget.setXY(thisTarget.x + ${x}, thisTarget.y + ${y})\n`
}
...
Blockly.JavaScript.forBlock.pointInDirection = function(block) {
    ...
    return `thisTarget.setDirection(${dir})\n`
}
...
Blockly.JavaScript.forBlock.pointTowards = function(block) {
    ...
    if (block.getInput('value')) {
        const value = Blockly.JavaScript.valueToCode(block, "value", 0) ?? '{}'
        return `util.target.setDirection(90 - MathUtil.radToDeg(Math.atan2(findPosition(${preset}, ${value})[1] - thisTarget.y, findPosition(${preset}, ${value})[0] - thisTarget.x)))\n`
    }
    return `util.target.setDirection(90 - MathUtil.radToDeg(Math.atan2(findPosition(${preset})[1] - thisTarget.y, findPosition(${preset})[0] - thisTarget.x)))\n`
}
...
Blockly.JavaScript.forBlock.pointTowardsXY = function(block) {
    const x = Blockly.JavaScript.valueToCode(block, "x", 0) || 0
    const y = Blockly.JavaScript.valueToCode(block, "y", 0) || 0
    return `util.target.setDirection(90 - MathUtil.radToDeg(Math.atan2(${y} - thisTarget.y, ${x} - thisTarget.x)))\n`
}
Blockly.Blocks.setX = {
    init: function() {
...
Blockly.JavaScript.forBlock.setX = function(block) {
    ...
    return `thisTarget.setXY(${value}, thisTarget.y)\n`
}
...
Blockly.JavaScript.forBlock.changeX = function(block) {
    const value = Blockly.JavaScript.valueToCode(block, "value", 0) || 0
    return `thisTarget.setXY(thisTarget.x + ${value}, thisTarget.y)\n`
}
Blockly.Blocks.setY = {
    init: function() {
...
Blockly.JavaScript.forBlock.setY = function(block) {
    const value = Blockly.JavaScript.valueToCode(block, "value", 0) || 0
    return `thisTarget.setXY(thisTarget.x, ${value})\n`
}
...
Blockly.JavaScript.forBlock.changeY = function(block) {
    const value = Blockly.JavaScript.valueToCode(block, "value", 0) || 0
    return `thisTarget.setXY(thisTarget.x, thisTarget.y + ${value})\n`
}
Blockly.Blocks.pointTowards = {
    init: function() {
...
Blockly.JavaScript.forBlock.pointTowards = function(block) {
    ...
    return `thisTarget.setRotationStyle(${style})\n`
}
...
Blockly.JavaScript.forBlock.position = function(block) {
    return ['new Vector(thisTarget.x, thisTarget.y)', 1.1]
}
...
Blockly.JavaScript.forBlock.direction = function(block) {
    return ['thisTarget.direction', 1.2]
}